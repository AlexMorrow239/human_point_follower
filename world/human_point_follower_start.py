...
hsr_omniverse_path = subprocess.getoutput(f"rospack find hsr-omniverse")
ISAAC_WORLD_PATH = os.path.join(hsr_omniverse_path, ISAAC_WORLD_NAME)
...
hsr_to_neutral_cmd = f"rosrun assignment-2-visseru-1 hsr_to_neutral.py"
...
processes = {
    ...
    # "hsr_to_neutral": process_handler.start_process(hsr_to_neutral_cmd, capture_output=False)
}
